<template>
    <div style="height: 100%;">
        <div class="flex end-h" style="margin-bottom: 16px;">
            <el-button style="width: 120px; height: 60px; font-size: 20px;" type="info">
                {{ $t('message.reset') }}
            </el-button>
            <el-button @click="save" style="width: 120px; height: 60px; font-size: 20px;" type="info">
                {{ $t('message.save') }}
            </el-button>
        </div>
        ...
        <div class="content-card-no-padding">
            ...
            <div class="flex between" style="padding: 20px;">
                ...
                <div>
                    <el-button @click="importLang" style="width: 120px; height: 60px; font-size: 20px;" type="info" plain>{{ $t('message.langImport')
                        }}
                    </el-button>
                    <el-button @click="exportLang" style="width: 120px; height: 60px; font-size: 20px; margin-left: 20px;" type="info" plain>{{
            ...
            <div class="flex between" style="padding: 20px;">
                ...
                <el-button  style="width: 120px; height: 60px; font-size: 20px;" type="info" plain>변경</el-button>
            </div>
        </div>
        <!-- 여기서 부터 Dialog -->
        <el-dialog title="비밀번호를 입력해 주세요" :visible.sync="visible">
            <div class="flex column center" style="height: 300px;">
                <div class="flex" style="position: relative;">
                    <NumKeyBoard :num="field.password" name="password" type="password" :numClick="handleNumClick"
                                 width="350" height="60"/>
    ...
    export default {
        ...
        methods: {
            ...
            handleNumClick(n, field) {
                /*if (n === '←') {
                    this.field[field] = this.field[field].substr(0, this.field[field] - 1)
